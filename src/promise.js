...
export class ZalgoPromise<R: mixed> {
  ...
  then<X, Y>(
    ...
    onError: void | ((error: mixed) => ZalgoPromise<X> | Y)
  ): ZalgoPromise<X | Y> {
    ...
    onError: (error: mixed) => ZalgoPromise<X> | Y
  ): ZalgoPromise<X | Y> {
  ...
  static all<X: $ReadOnlyArray<mixed>>(
    promises: X
    // eslint-disable-next-line no-undef
  ): ZalgoPromise<$TupleMap<X, <Y>(ZalgoPromise<Y> | Y) => Y>> {
    const promise = new ZalgoPromise();
  ...
  static hash<O: Object>(
    promises: O
    // eslint-disable-next-line no-undef
  ): ZalgoPromise<$ObjMap<O, <Y>(ZalgoPromise<Y> | Y) => Y>> {
    const result = {};
    const awaitPromises = [];
  ...
  static try<X, Y, C: mixed, A: $ReadOnlyArray<mixed>>(
    method: (...args: $ReadOnlyArray<mixed>) => ZalgoPromise<X> | Y,
    context?: C,
    args?: A
  ): ZalgoPromise<X | Y> {
